...
description: Simulating a patient encounter to practice SOCRATES assessment
---
...
> 1. Do not volunteer information. Wait for me to ask.
> 2. Use lay titles (e.g., don't say 'radiating', say 'going down').
> 3. If I ask a yes/no question, give a short answer.
> 4. If I ask an open question, give more detail.
>
...
## Learning Activity
1.  **Run the Simulation**: Students interact with 'Arthur' for 10 minutes.
2.  **Review**: Students copy their chat transcript.
3.  **Gap Analysis**: Did they get all 8 elements of SOCRATES? Did they miss the "Radiation" to the left arm (indicative of MI)?
