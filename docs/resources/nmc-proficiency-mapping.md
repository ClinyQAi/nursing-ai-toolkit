---
sidebar_position: 5
title: NMC Proficiency Mapping Tool
description: Map your AI-enhanced teaching activities directly to NMC Standards of Proficiency
---

import NMCMap from '@site/src/components/NMCMap';

# 🗺️ NMC Proficiency Mapping Tool
